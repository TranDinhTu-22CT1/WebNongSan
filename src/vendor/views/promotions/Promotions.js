...
// --- CẤU HÌNH API ---
const API_URL = 'http://localhost/nongsan-api/promotions.php';
const PRODUCT_API_URL = 'http://localhost/nongsan-api/products.php'; 
  ...
  return (
    <div className="promotions-page-container">
      <style>{`
        ...
        .table-green-custom thead th { background-color: #1E3923; color: #b7e4c7; font-weight: 700; border-bottom: 2px solid #558b6e; padding: 14px 16px; }
        ...
        .coupon-code { background-color: #ffd166; color: #1E3923; padding: 4px 8px; border-radius: 4px; font-weight: bold; font-family: monospace; letter-spacing: 1px; display: inline-block; border: 1px dashed #1E3923; }
        .text-value { color: #ffd166; font-weight: bold; }
        .btn-action:hover { color: #ffd166 !important; transform: scale(1.1); transition: 0.2s; }
      `}</style>
      ...
      <CCard className="card-green-theme mb-4">
        <CCardHeader className="border-bottom border-secondary pt-3 pb-3 d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
          <h5 className="mb-0 fw-bold d-flex align-items-center" style={{color: '#d8f3dc'}}>
