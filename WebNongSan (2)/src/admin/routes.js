...
const supportchat = React.lazy(() => import('../admin/views/SupportChat/SupportChat'))
const routes = [
  ...
  { path: '/admin/category', name: ' Category', element: Category},
    { path: '/admin/sale', name: ' Sale', element: Sale},
    ...
    {path : '/admin/support-chat', name: 'Support Chat', element: supportchat},
]
