...
const getNavItems = (unreadCount) => [
...

  {
    ...
    items: [
      ...
      { component: CNavItem, name: 'Vận chuyển', to: '/vendor/shipping' },
    ],
  },

  {
    ...
    items: [
      ...
      { component: CNavItem, name: 'Biểu đồ', to: '/vendor/charts' },
    ],
  },
...

  {
    ...
    items: [
      ...
      { component: CNavItem, name: 'Đánh giá & phản hồi', to: '/vendor/reviews' },
