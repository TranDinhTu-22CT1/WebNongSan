  ...
  return (
    <div className="invoice-page-container">
      <style>{`
        ...
        .form-control-green:focus { background-color: #1E3923; border-color: #95d5b2; color: #fff; box-shadow: 0 0 0 0.25rem rgba(118, 200, 147, 0.25); }
        .text-price { color: #ffd166; font-weight: 700; }
        .invoice-box { border: 1px solid #558b6e; padding: 20px; border-radius: 8px; background-color: #1E3923; }
        .cancel-reason-box { background-color: rgba(239, 71, 111, 0.15); border: 1px dashed #ef476f; color: #ffadb6; padding: 15px; border-radius: 8px; margin-bottom: 20px; }
