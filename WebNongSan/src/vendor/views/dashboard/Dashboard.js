          ...
          <CWidgetStatsA
            ...
            action={
              <CDropdown alignment="end">
                ...
                <CDropdownMenu><CDropdownItem onClick={() => navigate('/products')}>Xem tất cả</CDropdownItem></CDropdownMenu>
              </CDropdown>
            }
          ...
          <CWidgetStatsA
            ...
            action={
              <CDropdown alignment="end">
                ...
                <CDropdownMenu><CDropdownItem onClick={() => navigate('/invoice')}>Xem chi tiết</CDropdownItem></CDropdownMenu>
              </CDropdown>
            }
